...
const PUBLIC_ROUTES = ['/setup', '/lock', '/api/auth/setup', '/api/auth/login', '/api/auth/salt', '/api/capabilities', '/api/admin/seed', '/api/email/inbound', '/_next', '/sw.js', '/manifest.json', '/icons'];
