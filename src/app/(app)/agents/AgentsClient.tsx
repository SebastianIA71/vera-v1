    ...
    <div style={{ flex: 1, overflowY: 'auto', padding: isMobile ? '0' : '0 24px 80px', maxWidth: isMobile ? undefined : 800 }}>
      ...
      <div style={{ padding: '20px 20px 14px', borderBottom: '.5px solid var(--bg4)' }}>
        <div>
          ...
          <div style={{ fontFamily: 'var(--font-dm-mono)', fontSize: 10, letterSpacing: '.18em', color: 'var(--text3)', marginTop: 4 }}>v.27</div>
        </div>
      </div>
          ...
          <div key={sec.id}>
            ...
            >
              ...
              <div style={{ flex: 1, textAlign: 'left' }}>
                ...
                <div style={{ fontFamily: 'var(--font-dm-mono)', fontSize: 10, letterSpacing: '.14em', color: 'var(--text3)', marginTop: 3 }}>{sec.desc}</div>
              </div>
